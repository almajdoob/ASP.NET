...
namespace AlmajdoobUniversity.Migrations
{
    public partial class Inheritance : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO dbo.Person (LastName, FirstName, Email, HireDate, EnrollmentDate, Discriminator, OldId) SELECT LastName, FirstName, Email, null AS HireDate, EnrollmentDate, 'Student' AS Discriminator, ID AS OldId FROM dbo.Student");
